...
TERMUX_PKG_DEPENDS="libcurl, liblzma, dpkg, libc++, termux-exec"
TERMUX_PKG_VERSION=1.4.8
TERMUX_PKG_REVISION=3
TERMUX_PKG_SHA256=767ad7d6efb64cde52faececb7d3c0bf49800b9fe06f3a5b0132ab4c01a5b8f8
TERMUX_PKG_SRCURL=https://launchpad.net/debian/+archive/primary/+sourcefiles/apt/1.4.8/apt_${TERMUX_PKG_VERSION}.tar.xz
